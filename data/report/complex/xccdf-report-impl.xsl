...
<xsl:template name="compliance-and-scoring">
    ...
    <div id="compliance-and-scoring">
        ...
        <div class="progress" title="Displays proportion of passed/fixed, failed/error, and other rules (in that order). There were {$total_rules_count - $ignored_rules_count} rules taken into account.">
            ...
            <div class="progress-bar progress-bar-danger" style="width: {$needs_inspection_rules_count div ($total_rules_count - $ignored_rules_count) * 100}%">
                <xsl:value-of select="$needs_inspection_rules_count"/> needs_inspection
            </div>
            ...
            <div class="row">
                <div title="Filter rules by their XCCDF result">
                    ...
                    <div class="col-sm-2 toggle-rule-display-danger">
                        ...
                        <div class="checkbox">
                            <label><input class="toggle-rule-display" type="checkbox" onclick="toggleRuleDisplay(this)" checked="checked" value="needs_action"/>needs_action</label>
                        </div>
                        <div class="checkbox">
                            <label><input class="toggle-rule-display" type="checkbox" onclick="toggleRuleDisplay(this)" checked="checked" value="needs_inspection"/>needs_inspection</label>
                        </div>
                        <div class="checkbox">
