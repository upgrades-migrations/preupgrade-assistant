...
#
from preup_pykickstart.base import KickstartCommand
from preup_pykickstart.errors import KickstartParseError, formatErrorMsg
from preup_pykickstart.options import KSOptionParser

import gettext
_ = lambda x: gettext.ldgettext("pykickstart", x)

class RHEL7_ReqPart(KickstartCommand):
